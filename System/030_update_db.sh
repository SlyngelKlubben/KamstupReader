...
PGPASSWORD=$DBPW psql -U $DBUSER $DB -tAc "CREATE INDEX el_timestamp_idx ON el (timestamp);"
...
PGPASSWORD=$DBPW psql -U $DBUSER $DB -tAc "CREATE INDEX vand_timestamp_idx ON vand (timestamp);"
...
PGPASSWORD=$DBPW psql -U $DBUSER $DB -tAc "CREATE INDEX envi_timestamp_idx ON envi (timestamp);"
